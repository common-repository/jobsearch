...
{/if}
    <div class="tdb-jd-container tdb-jd-search-container">
        ...
        <div class ='{$containerHiddenCss}' id ='tdb-advanced-search'>
            {if $isMultipleFieldEmpty == false}
                <div class = "tdb-jd-container tdb-jd-kind-job-container" id="jobsContainer">
            ...
            <!--tags -->
            <div class = "tdb-jd-container tdb-jd-tags-container" id="tagsContainer">
